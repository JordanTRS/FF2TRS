...
function module:GetTeam(teamName)
	...
	elseif (string.lower(teamName) == "rubies") then
        return {
            City = "Florida",
            Name = "Rubies",
            Abbreviation = "TRS",
	...
	elseif (string.lower(teamName) == "ugf") then
        return {
            City = "UGF",
            Name = "Pandas",
            Abbreviation = "UGF",
	...
	elseif (string.lower(teamName) == "dvsu") then
        return {
            City = "DVSU",
            Name = "Dingos",
            Abbreviation = "DVSU",
	...
	elseif (string.lower(teamName) == "rocket city") then
        return {
            City = "Rocket City",
            Name = "Moon Men",
            Abbreviation = "RCU",
